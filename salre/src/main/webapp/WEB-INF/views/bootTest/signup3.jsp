...
<section class="pt-0">
	...
	<div class="container-fluid px-0">
		<div class="bg-blue h-100px h-md-200px rounded-0" style="background:url(resources/images/pattern/04.png) no-repeat center center; background-size:cover;">
		</div>
	</div>
					...
					<div class="row d-flex justify-content-between">
						...
						<div class="col-auto mt-4 mt-md-0">
							<div class="avatar avatar-xxl mt-n3">
								<img class="avatar-img rounded-circle border border-white border-3 shadow" src="resources/images/avatar/01.jpg" alt="">
							</div>
						</div>
						<!-- Profile info -->
								...
								<div class="d-flex align-items-center">
									<label class="position-relative me-4" for="uploadfile-1" title="Replace this pic">
										...
										<span class="avatar avatar-xl">
											<img id="uploadfile-1-preview" class="avatar-img rounded-circle border border-white border-3 shadow" src="resources/images/avatar/07.jpg" alt="">
										</span>
										<!-- Remove btn -->
	...
	<div class="container">
		<div class="row align-items-center">
			...
			<div class="col-md-4 text-center text-md-start mb-3 mb-md-0">
				<!-- Logo START -->
				<a href="index.html"> <img class="h-20px" src="resources/images/logo-light.svg" alt="logo"> </a>
			</div>
