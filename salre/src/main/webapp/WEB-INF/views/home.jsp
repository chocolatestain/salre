...
<body>
	...
	<header>
		...
		<nav>
			<a href="loan/main">대출상품</a> <a href="#">채팅</a> <a href="#">게시판</a> <a
				href="#">매물</a> <a href="#">관심매물</a> <a href="product/insert">방내놓기</a>
		</nav>
		<div class="auth">
	...
	<section class="stats">
		<p>
			현재 <span>${regionCount}</span>개의 지역에서 <span>@@@</span>명이 <span>${productCount }
			</span>개의 집을 보고 있습니다.
		</p>
	</section>
	...
	<script>
		...
		// 마커 이미지 설정
		var imageSrc = 'https://cdn-icons-png.flaticon.com/512/5973/5973800.png', imageSize = new kakao.maps.Size(
				40, 40), imageOption = {
		...
		{
			regions
		}; // 서버에서 전달된 JSON 데이터를 regions 변수에 할당

		regions.forEach(function(region) {
			var markerPosition = new kakao.maps.LatLng(region.latitude,
					region.longitude); // 위도와 경도로 위치 설정
