...
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" href="${contextPath}/resources/bootstrap/assets/images/favicon.ico">
...
<body>
		...
		<nav class="navbar navbar-expand-xl z-index-9">
			<div class="container">
				...
				<a class="navbar-brand" href="${contextPath}/index">
					<img class="light-mode-item navbar-brand-item" src="${contextPath}/resources/bootstrap/assets/images/logo.svg" alt="logo">
					<img class="dark-mode-item navbar-brand-item" src="${contextPath}/resources/bootstrap/assets/images/logo-light.svg" alt="logo">
				</a>
				<!-- Logo END -->
				...
				<div class="navbar-collapse collapse" id="navbarCollapse">
					...
					<ul class="navbar-nav navbar-nav-scroll ms-auto">
						<!-- Nav item 1 매물 -->
						<li class="nav-item dropdown"><a class="nav-link" href="#">매물</a></li>
	
						<!-- Nav item 2 방내놓기 -->
						<li class="nav-item dropdown"><a class="nav-link" href="#">방내놓기</a></li>
				...
				<ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
	                    ...
	                    <a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
	                      <div class="me-3">
	                        <div class="avatar avatar-md">
	                          <img class="avatar-img rounded-circle" src="${contextPath}/resources/bootstrap/assets/images/avatar/03.jpg" alt="avatar">
	                        </div>
	                      </div>
	                      <div>
					...
					<li class="nav-item ms-3 dropdown">
						...
						<a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
							<img class="avatar-img rounded-circle" src="${contextPath}/resources/bootstrap/assets/images/avatar/01.jpg" alt="avatar">
						</a>
							...
							<li class="px-3 mb-3">
								<div class="d-flex align-items-center">
									...
									<div class="avatar me-3">
										<img class="avatar-img rounded-circle shadow" src="${contextPath}/resources/bootstrap/assets/images/avatar/01.jpg" alt="avatar">
									</div>
									<div>
				...
				<div class="navbar-collapse w-100 collapse" id="navbarCollapse2">
					...
					<ul class="navbar-nav navbar-nav-scroll mx-auto">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle active" href="#" id="demoMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Development</a>
						...
						<!-- Nav item 3 link -->
						<li class="nav-item"><a class="nav-link" href="#">Personal Development</a></li>
	
						<!-- Nav item 4 link-->
						<li class="nav-item"><a class="nav-link" href="#">IT & Software</a></li>
				...
				<div class="col-lg-5 col-xl-6 text-center position-relative">
					...
					<div class="p-3 card card-body shadow rounded-4 position-absolute top-0 start-0 translate-middle ms-5 z-index-1 d-none d-xl-block">
						<div class="d-flex justify-content-between">
							<!-- Avatar -->
							<div class="avatar">
								<img class="avatar-img rounded-circle shadow" src="${contextPath}/resources/bootstrap/assets/images/avatar/04.jpg" alt="avatar">
							</div>
							<!-- Info -->
					...
					<div class="position-absolute top-100 start-100 translate-middle z-index-1 ms-n6 mt-n5 d-none d-xxl-block">
						<div class="card card-body shadow p-4 rounded-3 d-inline-block position-relative z-index-1">
							...
							<ul class="avatar-group mb-2">
								...
								<li class="avatar avatar-sm">
									<img class="avatar-img rounded-circle" src="${contextPath}/resources/bootstrap/assets/images/avatar/02.jpg" alt="avatar">
								</li>
								<li class="avatar avatar-sm">
									<img class="avatar-img rounded-circle" src="${contextPath}/resources/bootstrap/assets/images/avatar/03.jpg" alt="avatar">
								</li>
					...
					<div class=" position-relative">
						...
						<!-- Image -->
						<img src="${contextPath}/resources/bootstrap/assets/images/element/06.png" class="position-absolute bottom-0 start-50 translate-middle-x"  alt="">
					</div>
							...
							<div class="tiny-slider-inner" data-autoplay="true" data-gutter="80" data-arrow="true" data-dots="false" data-items="5" data-items-lg="3" data-items-md="2" data-items-xs="1">
								...
								<div>
									<div class="bg-body text-center rounded-2 border py-2 px-1 position-relative">
										<img src="${contextPath}/resources/bootstrap/assets/images/element/22.svg" class="h-40px" alt="">
								...
								<div>
									<div class="bg-body text-center rounded-2 border py-2 px-1 position-relative">
										<img src="${contextPath}/resources/bootstrap/assets/images/element/23.svg" class="h-40px" alt="">
								...
								<div>
									<div class="bg-body text-center rounded-2 border py-2 px-1 position-relative">
										<img src="${contextPath}/resources/bootstrap/assets/images/element/21.svg" class="h-40px" alt="">
								...
								<div>
									<div class="bg-body text-center rounded-2 border py-2 px-1 position-relative">
										<img src="${contextPath}/resources/bootstrap/assets/images/element/24.svg" class="h-40px" alt="">
								...
								<div>
									<div class="bg-body text-center rounded-2 border py-2 px-1 position-relative">
										<img src="${contextPath}/resources/bootstrap/assets/images/element/25.svg" class="h-40px" alt="">
								...
								<div>
									<div class="bg-body text-center rounded-2 border py-2 px-1 position-relative">
										<img src="${contextPath}/resources/bootstrap/assets/images/element/26.svg" class="h-40px" alt="">
			...
			<div class="row g-4">
				...
				<div class="col-xl-8">
					<div class="card p-2 bg-transparent border">
						<div class="row g-0">
							<div class="col-md-3">
								<img src="${contextPath}/resources/bootstrap/assets/images/courses/4by3/01.jpg" class="rounded-2" alt="Card image">
							</div>
							<div class="col-md-9">
								<div class="card-body">
									<!-- Badge and dropdown -->
									...
									<div class="overflow-hidden mt-3">
										...
										<div class="progress progress-sm bg-success bg-opacity-10">
											<div class="progress-bar bg-success aos" role="progressbar" data-aos="slide-right" data-aos-delay="200" data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 20%;" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
											</div>
										</div>
									</div>
			...
			<div class="row g-4">
				...
				<div class="col-md-6 col-xl-4">
					<div class="card shadow-hover overflow-hidden bg-transparent">
						<div class="position-relative">
							<!-- Image -->
							<img class="card-img-top" src="${contextPath}/resources/bootstrap/assets/images/courses/4by3/16.jpg" alt="Card image">
							<!-- Overlay -->
								...
								<div class="w-100 mt-auto d-inline-flex">
									<div class="d-flex align-items-center bg-white p-2 rounded-2">
										...
										<div class="avatar avatar-sm me-2">
											<img class="avatar-img rounded-1" src="${contextPath}/resources/bootstrap/assets/images/avatar/10.jpg" alt="avatar">
										</div>
										<!-- Avatar info -->
										<div>
				...
				<div class="col-md-6 col-xl-4">
					<div class="card shadow-hover overflow-hidden bg-transparent">
						<div class="position-relative">
							<!-- Image -->
							<img class="card-img-top" src="${contextPath}/resources/bootstrap/assets/images/courses/4by3/14.jpg" alt="Card image">
							<!-- Overlay -->
							<div class="bg-overlay bg-dark opacity-4"></div>
							<div class="card-img-overlay d-flex align-items-start flex-column">
								<!-- Card overlay bottom -->
								<div class="w-100 mt-auto d-inline-flex">
									<div class="d-flex align-items-center bg-white p-2 rounded-2">
										<!-- Avatar -->
										<div class="avatar avatar-sm me-2">
											<img class="avatar-img rounded-1" src="${contextPath}/resources/bootstrap/assets/images/avatar/08.jpg" alt="avatar">
										</div>
										<!-- Avatar info -->
										<div>
							...
							<!-- Badge and icon -->
	 						<div class="d-flex justify-content-between mb-3">
								<div class="hstack gap-2">
									...
									<a href="#" class="badge text-bg-dark">8 month</a>
								</div>
				...
				<div class="col-md-6 col-xl-4">
					<div class="card shadow-hover overflow-hidden bg-transparent">
						<div class="position-relative">
							<!-- Image -->
							<img class="card-img-top" src="${contextPath}/resources/bootstrap/assets/images/courses/4by3/21.jpg" alt="Card image">
							<!-- Overlay -->
							<div class="bg-overlay bg-dark opacity-4"></div>
							<div class="card-img-overlay d-flex align-items-start flex-column">
								<!-- Card overlay bottom -->
								<div class="w-100 mt-auto d-inline-flex">
									<div class="d-flex align-items-center bg-white p-2 rounded-2">
										<!-- Avatar -->
										<div class="avatar avatar-sm me-2">
											<img class="avatar-img rounded-1" src="${contextPath}/resources/bootstrap/assets/images/avatar/05.jpg" alt="avatar">
										</div>
										<!-- Avatar info -->
										<div>
						...
						<div class="card-body">
							...
							<div class="d-flex justify-content-between mb-3">
								<div class="hstack gap-2">
									<a href="#" class="badge bg-info bg-opacity-10 text-info">Beginner</a>
									<a href="#" class="badge text-bg-dark">12 month</a>
								</div>
								...
								<div class="col-lg-6 position-relative">
									...
									<div class="tab-content mb-0 pb-0" id="course-pills-tabContent1">
										...
										<div class="tab-pane fade show active" id="course-pills-tab01" role="tabpanel" aria-labelledby="course-pills-tab-01">
											...
											<div class="card p-2 pb-0 shadow">
												<div class="overflow-hidden h-xl-200px">
													<img src="${contextPath}/resources/bootstrap/assets/images/about/13.jpg" class="card-img-top" alt="course image">
										...
										<div class="tab-pane fade" id="course-pills-tab02" role="tabpanel" aria-labelledby="course-pills-tab-02">
											...
											<div class="card p-2 pb-0 shadow">
												<div class="overflow-hidden h-xl-200px">
													<img src="${contextPath}/resources/bootstrap/assets/images/about/11.jpg" class="card-img-top" alt="course image">
													<div class="card-img-overlay d-flex p-3">
														<!-- Video button and link -->
														<div class="m-auto">
															<a href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox="" data-gallery="course-video">
										...
										<div class="tab-pane fade" id="course-pills-tab03" role="tabpanel" aria-labelledby="course-pills-tab-03">
											...
											<div class="card p-2 shadow">
												<div class="overflow-hidden h-xl-200px">
													<img src="${contextPath}/resources/bootstrap/assets/images/about/14.jpg" class="card-img-top" alt="course image">
													<div class="card-img-overlay d-flex p-3">
														<!-- Video button and link -->
														<div class="m-auto">
															<a href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox="" data-gallery="course-video">
						...
						<div class="col-lg-6">
							...
							<div class="card p-2 shadow">
								<div class="overflow-hidden rounded-3 h-xl-200px">
									<img src="${contextPath}/resources/bootstrap/assets/images/about/15.jpg" class="card-img rounded-3" alt="course image">
									<div class="card-img-overlay d-flex p-3">
										<!-- Video button and link -->
										<div class="m-auto">
											<a href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox="" data-gallery="course-video">
				...
				<div class="tab-pane fade" id="course-pills-tab4" role="tabpanel" aria-labelledby="course-pills-tab-4">
					<div class="row g-4">
						...
						<div class="col-lg-6">
							...
							<div class="card p-2 shadow">
								<div class="overflow-hidden rounded-3 h-xl-200px">
									<img src="${contextPath}/resources/bootstrap/assets/images/about/12.jpg" class="card-img rounded-3" alt="course image">
									<div class="card-img-overlay d-flex p-3">
										<!-- Video button and link -->
										<div class="m-auto">
											<a href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox="" data-gallery="course-video">
				...
				<div class="tab-pane fade" id="course-pills-tab5" role="tabpanel" aria-labelledby="course-pills-tab-5">
					<div class="row g-4">
						...
						<div class="col-lg-6">
							...
							<div class="card p-2 shadow">
								<div class="overflow-hidden rounded-3 h-xl-200px">
									<img src="${contextPath}/resources/bootstrap/assets/images/about/11.jpg" class="card-img rounded-3" alt="course image">
									<div class="card-img-overlay d-flex p-3">
										<!-- Video button and link -->
										<div class="m-auto">
											<a href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-lg text-danger btn-round btn-white-shadow mb-0" data-glightbox="" data-gallery="course-video">
				...
				<div class="tiny-slider arrow-round arrow-creative arrow-blur">
					<div class="tiny-slider-inner" data-autoplay="true" data-arrow="true" data-dots="false" data-items="4" data-items-lg="3" data-items-md="2" data-items-xs="1">
						...
						<div class="card bg-transparent">
							<div class="position-relative">
								<!-- Image -->
								<img src="${contextPath}/resources/bootstrap/assets/images/instructor/02.jpg" class="card-img" alt="course image">
								<!-- Overlay -->
						...
						<div class="card bg-transparent">
							<div class="position-relative">
								<!-- Image -->
								<img src="${contextPath}/resources/bootstrap/assets/images/instructor/01.jpg" class="card-img" alt="course image">
								<!-- Overlay -->
								<div class="card-img-overlay d-flex flex-column p-3">
									<div class="w-100 mt-auto text-end">
										<!-- Card category -->
						...
						<div class="card bg-transparent">
							<div class="position-relative">
								<!-- Image -->
								<img src="${contextPath}/resources/bootstrap/assets/images/instructor/08.jpg" class="card-img" alt="course image">
								<!-- Overlay -->
								<div class="card-img-overlay d-flex flex-column p-3">
									<div class="w-100 mt-auto text-end">
										<!-- Card category -->
						...
						<div class="card bg-transparent">
							<div class="position-relative">
								<!-- Image -->
								<img src="${contextPath}/resources/bootstrap/assets/images/instructor/04.jpg" class="card-img" alt="course image">
								<!-- Overlay -->
								<div class="card-img-overlay d-flex flex-column p-3">
									<div class="w-100 mt-auto text-end">
										<!-- Card category -->
						...
						<div class="card bg-transparent">
							<div class="position-relative">
								<!-- Image -->
								<img src="${contextPath}/resources/bootstrap/assets/images/instructor/03.jpg" class="card-img" alt="course image">
								<!-- Overlay -->
								<div class="card-img-overlay d-flex flex-column p-3">
									<div class="w-100 mt-auto text-end">
										<!-- Card category -->
			...
			<div class="row">
				<div class="col-12 position-relative z-index-1">
					...
					<div class="d-none d-lg-block position-absolute bottom-0 start-0 ms-3 ms-xl-5">
						<img src="${contextPath}/resources/bootstrap/assets/images/element/01.png" alt="">
					</div>
					<!-- Pencil and cap SVG -->
					<div class="position-absolute top-0 end-0 mt-n4 me-5">
						<img src="${contextPath}/resources/bootstrap/assets/images/client/pencil.svg" alt="">	
					</div>
					<div class="position-absolute bottom-0 start-50 mb-n4">
						<img src="${contextPath}/resources/bootstrap/assets/images/client/graduated.svg" class="rotate-74" alt="">	
					</div>
				...
				<div class="col-12">
					...
					<div class="tiny-slider arrow-round">
						<div class="tiny-slider-inner" data-arrow="false" data-autoplay="true" data-dots="false" data-gutter="80" data-items-xl="6" data-items-lg="5" data-items-md="4" data-items-sm="3" data-items-xs="2">
							<!-- Slide item START -->
							<div class="item"> <img src="${contextPath}/resources/bootstrap/assets/images/client/coca-cola.svg" alt=""> </div>
							<div class="item"> <img src="${contextPath}/resources/bootstrap/assets/images/client/android.svg" alt=""> </div>
							<div class="item"> <img src="${contextPath}/resources/bootstrap/assets/images/client/envato.svg" alt=""> </div>
							<div class="item"> <img src="${contextPath}/resources/bootstrap/assets/images/client/microsoft.svg" alt=""> </div>
							<div class="item"> <img src="${contextPath}/resources/bootstrap/assets/images/client/netflix.svg" alt=""> </div>
							<div class="item"> <img src="${contextPath}/resources/bootstrap/assets/images/client/google.svg" alt=""> </div>
							<div class="item"> <img src="${contextPath}/resources/bootstrap/assets/images/client/linkedin.svg" alt=""> </div>
							<!-- Slide item END -->
						</div>
					</div>
					<!-- Slider END -->
			...
			<div class="row g-4">
				...
				<div class="col-lg-3">
					...
					<a class="me-0" href="index.html">
						<img class="h-40px" src="${contextPath}/resources/bootstrap/assets/images/logo-light.svg" alt="logo">
					</a>
				...
				<div class="col-lg-3">
					...
					<div class="row g-2 mt-2">
						...
						<div class="col-6 col-sm-4 col-md-3 col-lg-6">
							<a href="#"> <img src="${contextPath}/resources/bootstrap/assets/images/client/google-play.svg" alt=""> </a>
						</div>
						<!-- App store button -->
						<div class="col-6 col-sm-4 col-md-3 col-lg-6">
							<a href="#"> <img src="${contextPath}/resources/bootstrap/assets/images/client/app-store.svg" alt="app-store"> </a>
						</div>
					</div> <!-- Row END -->
				</div> 
				<!-- Widget 3 END -->
								...
								<li class="list-inline-item text-primary-hover">
									...
									<div class="dropup mt-0 text-center text-sm-end">
										...
										<ul class="dropdown-menu min-w-auto" aria-labelledby="languageSwitcher">
											<li><a class="dropdown-item me-4 text-body" href="#"><img class="fa-fw me-2" src="${contextPath}/resources/bootstrap/assets/images/flags/uk.svg" alt="">English</a></li>
											<li><a class="dropdown-item me-4 text-body" href="#"><img class="fa-fw me-2" src="${contextPath}/resources/bootstrap/assets/images/flags/gr.svg" alt="">German </a></li>
											<li><a class="dropdown-item me-4 text-body" href="#"><img class="fa-fw me-2" src="${contextPath}/resources/bootstrap/assets/images/flags/sp.svg" alt="">French</a></li>
										</ul>
									</div>
								</li>
	...
	<!-- Vendors -->
	<script src="${contextPath}/resources/bootstrap/assets/vendor/tiny-slider/tiny-slider.js"></script>
	<script src="${contextPath}/resources/bootstrap/assets/vendor/glightbox/js/glightbox.js"></script>
	<script src="${contextPath}/resources/bootstrap/assets/vendor/purecounterjs/dist/purecounter_vanilla.js"></script>
